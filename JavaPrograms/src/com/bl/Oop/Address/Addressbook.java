...
Scanner sc =new Scanner(System.in);
	...
	public void editPerson()
	{
		...
		Optional<Person> optional = listOfPerson.parallelStream().filter(person -> firstName.equals(person.getFirstName()) && lastName.equals(person.getLastName()))
				.findAny();
	...
	{
		Collections.sort(listOfPerson,(person1, person2) -> person1.getAddress().getZipcode() > person2.getAddress().getZipcode() ? 1
	...
	{
		//strArray = new String[listOfPerson.size()];
		
		//strArray = listOfPerson.toArray(strArray);
